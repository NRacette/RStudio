...
# Alternatively, these true confidence levels can be found using 
# the binom.coverage() function in the binom package
library(binom)
...
#  function in the binom package. Note that the method argument uses a 
# function name that calculates the individual confidence interval 
# (binom.asymp is within the binom package. Also, the y-axis is the 
# true confidence level and the x-axis is pi. The 
#  lattice package is used for plotting so the usual arguments
# (like xlab = ) for basic  R plots do not always work.  
x11(width = 7, height = 6, pointsize = 12)
